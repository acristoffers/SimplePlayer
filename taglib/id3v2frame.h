...
namespace TagLib
{
    ...
    namespace ID3v2
    {
        ...
        public:
            ...
            /*!
             * Returns the Frame ID (Structure, <a href="id3v2-structure.html#4">4</a>) (Frames, <a href="id3v2-frames.html#4">4</a>)
             */
             ...
             *
             * \deprecated This is only accurate for ID3v2.3 or ID3v2.4.  Please use the call below which accepts an ID3v2 version number.  In the next non-binary compatible release this will be made into a non-static member that checks the internal ID3v2 version.
             */
             ...
             *
             * \note If the frame type supports multiple text encodings, this will not change the text encoding of the frame; the string will be converted to that frame's encoding.  Please use the specific APIs of the frame types to set the encoding if that is desired.
             */
             ...
             * used to translate PropertyMaps to TMCL frames. In the current implementation, this is "PERFORMER:".
             */
        ...
        protected:
            ...
            /*!
             * Constructs an ID3v2 frame using \a data to read the header information. All other processing of \a data should be handled in a subclass.
             *
            ...
            /*!
             * Reads a String of type \a encodiong from the ByteVector \a data.  If \a position is passed in it is used both as the starting point and is updated to replect the position just after the string that has been read. This is useful for reading strings sequentially.
             */
            ...
            /*!
             * Returns an appropriate ID3 frame ID for the given free-form tag key. This method will return ByteVector::null if no specialized translation is found.
             */
            static ByteVector keyToFrameID(const String &);

            /*!
             * Returns a free-form tag name for the given ID3 frame ID. Note that this does not work for general frame IDs such as TXXX or WXXX; in such a case String::null is returned.
             */
             ...
             * - \a singleFrameProperties contains only of keys which can be represented with exactly one ID3 frame per key. In the current implementation this is everything except for the fixed "involved people" keys and keys of the form "TextIdentificationFrame::instrumentPrefix" + "instrument", which are mapped to a TMCL frame.
        ...
        public:
            /*!
             * Construct a Frame Header based on \a data.  \a data must at least contain a 4 byte frame ID, and optionally can contain flag data and the frame size.  i.e. Just the frame id -- "TALB" -- is a valid value.
             *
             * \deprecated Please use the constructor below that accepts a version number.
             */
             ...
             *
             * \deprecated Please use the version below that accepts an ID3v2 version number.
             */
            void setData(const ByteVector &data, bool synchSafeInts);

            /*!
             * Sets the data for the Header.  \a version should indicate the ID3v2 version number of the tag that this frame is contained in.
             */
             ...
             *
             * \warning This method should in general be avoided.  It exists simply to provide a mechanism for transforming frames from a deprecated frame type to a newer one -- i.e. TYER to TDRC from ID3v2.3 to ID3v2.4.
             */
             ...
             *
             * \deprecated Please use the version of this method that accepts a version.  This is only accurate for ID3v2.3 and ID3v2.4.  This will be removed in the next binary incompatible release (2.0) and will be replaced with a non-static method that checks the frame version.
             */
            static uint size();
