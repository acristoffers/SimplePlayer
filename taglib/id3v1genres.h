...
namespace TagLib
{
    namespace ID3v1
    {
         ...
         * \a index is out of range -- less than zero or greater than 146 -- a null string will be returned.
         */
        String TAGLIB_EXPORT genre(int index);

        /*!
         * Returns the genre index for the (case sensitive) genre \a name.  If the genre is not in the list 255 (which signifies an unknown genre in ID3v1) will be returned.
         */
