...
namespace TagLib
{
    ...
    namespace MP4
    {
        ...
        public:
            /*!
             * Constructs an MP4 file from \a file.  If \a readProperties is true the file's audio properties will also be read.
             *
            ...
            /*!
             * Constructs an MP4 file from \a stream.  If \a readProperties is true the file's audio properties will also be read.
             *
             ...
             *
             * \note The Tag <b>is still</b> owned by the MP4::File and should not be deleted by the user.  It will be deleted when the file (object) is destroyed.
             */
            Tag *tag() const;
