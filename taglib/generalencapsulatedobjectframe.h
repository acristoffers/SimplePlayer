...
namespace TagLib
{
    namespace ID3v2
    {
        ...
        public:
             ...
             *
             * \warning This is \em not data for the encapsulated object, for that use setObject().  This constructor is used when reading the frame from the disk.
             */
            ...
            /*!
             * Sets the object data to \a data.  \a data should be of the type specified in this frame's mime-type specification.
             *
             * \see object()
             * \see mimeType()
             * \see setMimeType()
