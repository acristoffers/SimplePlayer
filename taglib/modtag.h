...
namespace TagLib
{
    namespace Mod
    {
         ...
         *
         * Note that only the \a title is supported as such by most module file formats.  Except for XM files the \a trackerName is derived from the file format or the flavour of the file format.  For XM files it is stored in the file.
         *
         * The \a comment tag is not strictly supported by module files, but it is common practice to abuse instrument/sample/pattern names as multiline comments.  TagLib does so as well.
         */
        ...
        public:
            ...
            /*!
             * Returns the name of the tracker used to create/edit the module file. Only XM files store this tag to the file as such, for other formats (Mod, S3M, IT) this is derived from the file type or the flavour of the file type.  Therefore only XM files might have an empty (String::null) tracker name.
             */
            String trackerName() const;

            /*!
             * Sets the title to \a title.  If \a title is String::null then this value will be cleared.
             *
            ...
            /*!
             * Sets the comment to \a comment.  If \a comment is String::null then this value will be cleared.
             *
            ...
            /*!
             * Sets the tracker name to \a trackerName.  If \a trackerName is String::null then this value will be cleared.
             *
            ...
            /*!
             * Implements the unified property interface -- import function. Because of the limitations of the module file tag, any tags besides COMMENT, TITLE and, if it is an XM file, TRACKERNAME, will be returened. Additionally, if the map contains tags with multiple values, all but the first will be contained in the returned map of unsupported properties.
             */
