...
namespace TagLib
{
    ...
    public:
        ...
        /*!
         * Constructs a byte vector that copies \a data up to the first null byte.  The behavior is undefined if \a data is not null terminated. This is particularly useful for constructing byte arrays from string constants.
         */
        ...
        /*!
         * Sets the data for the byte array copies \a data up to the first null byte.  The behavior is undefined if \a data is not null terminated.
         */
        ...
        /*!
         * Returns a byte vector made up of the bytes starting at \a index and for \a length bytes.  If \a length is not specified it will return the bytes from \a index to the end of the vector.
         */
        ...
        /*!
         * Searches the ByteVector for \a pattern starting at \a offset and returns the offset.  Returns -1 if the pattern was not found.  If \a byteAlign is specified the pattern will only be matched if it starts on a byte divisible by \a byteAlign (starting from \a offset).
         */
        int find(const ByteVector &pattern, uint offset = 0, int byteAlign = 1) const;

        /*!
         * Searches the char for \a c starting at \a offset and returns the offset.  Returns \a npos if the pattern was not found.  If \a byteAlign is specified the pattern will only be matched if it starts on a byte divisible by \a byteAlign (starting from \a offset).
         */
        int find(char c, uint offset = 0, int byteAlign = 1) const;

        /*!
         * Searches the ByteVector for \a pattern starting from either the end of the vector or \a offset and returns the offset.  Returns -1 if the pattern was not found.  If \a byteAlign is specified the pattern will only be matched if it starts on a byte divisible by \a byteAlign (starting from \a offset).
         */
         ...
         * \a offset.  Optionally, if you only want to search for part of the pattern you can specify an offset within the pattern to start from.  Also, you can specify to only check for the first \a patternLength bytes of \a pattern with the \a patternLength argument.
         */
        ...
        /*!
         * Checks for a partial match of \a pattern at the end of the vector.  It returns the offset of the partial match within the vector, or -1 if the pattern is not found.  This method is particularly useful when searching for patterns that start in one vector and end in another.  When combined with startsWith() it can be used to find a pattern that overlaps two buffers.
         *
         ...
         * \a size, pad the remaining spaces with \a padding.  Returns a reference to the resized vector.
         */
         ...
         *
         * If \a mostSignificantByteFirst is true this will operate left to right evaluating the integer.  For example if \a mostSignificantByteFirst is true then $00 $00 $00 $01 == 0x00000001 == 1, if false, $01 00 00 00 ==
         * 0x01000000 == 1.
         *
         * \see fromUInt()
         */
        ...
        /*!
         * Converts the \a length bytes at \a offset of the vector to an unsigned integer. If \a length is larger than 4, the excess is ignored.
         *
         * If \a mostSignificantByteFirst is true this will operate left to right evaluating the integer.  For example if \a mostSignificantByteFirst is true then $00 $00 $00 $01 == 0x00000001 == 1, if false, $01 00 00 00 ==
         * 0x01000000 == 1.
         *
         ...
         *
         * If \a mostSignificantByteFirst is true this will operate left to right evaluating the integer.  For example if \a mostSignificantByteFirst is true then $00 $01 == 0x0001 == 1, if false, $01 00 == 0x01000000 == 1.
         *
         * \see fromShort()
         */
         ...
         *
         * If \a mostSignificantByteFirst is true this will operate left to right evaluating the integer.  For example if \a mostSignificantByteFirst is true then $00 00 00 00 00 00 00 01 == 0x0000000000000001 == 1, if false, $01 00 00 00 00 00 00 00 == 0x0100000000000000 == 1.
         *
         * \see fromUInt()
         */
         ...
         * \a mostSignificantByteFirst is true, then this will operate left to right in building the ByteVector.  For example if \a mostSignificantByteFirst is true then $00 00 00 01 == 0x00000001 == 1, if false, $01 00 00 00 ==
         * 0x01000000 == 1.
         *
         * \see toUInt()
         */
         ...
         * \a mostSignificantByteFirst is true, then this will operate left to right in building the ByteVector.  For example if \a mostSignificantByteFirst is true then $00 01 == 0x0001 == 1, if false, $01 00 == 0x0100 == 1.
         *
         * \see toShort()
         */
         ...
         * \a mostSignificantByteFirst is true, then this will operate left to right in building the ByteVector.  For example if \a mostSignificantByteFirst is true then $00 00 00 01 == 0x0000000000000001 == 1, if false,
        ...
        /*!
         * Returns true if this ByteVector is less than \a v.  The value of the vectors is determined by evaluating the character from left to right, and in the event one vector is a superset of the other, the size is used.
         */
        bool operator <(const ByteVector &v) const;
...
/*!
 * \relates TagLib::ByteVector Streams the ByteVector \a v to the output stream \a s.
 */
