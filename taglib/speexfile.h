...
namespace TagLib
{
    namespace Ogg
    {
        ...
        namespace Speex
        {
            ...
            public:
                /*!
                 * Constructs a Speex file from \a file.  If \a readProperties is true the file's audio properties will also be read.
                 *
                ...
                /*!
                 * Constructs a Speex file from \a stream.  If \a readProperties is true the file's audio properties will also be read.
                 *
