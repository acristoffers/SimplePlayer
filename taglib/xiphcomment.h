...
namespace TagLib
{
    namespace Ogg
    {
        ...
        public:
            ...
            /*!
             * Add the field specified by \a key with the data \a value.  If \a replace is true, then all of the other fields with the same key will be removed first.
             *
             ...
             * Renders the comment to a ByteVector suitable for inserting into a file.
             *
             * If \a addFramingBit is true the standard Vorbis comment framing bit will be appended.  However some formats (notably FLAC) do not work with this in place.
             */
