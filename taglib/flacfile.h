...
namespace TagLib
{
    ...
    namespace FLAC
    {
        ...
        public:
            /*!
             * Constructs a FLAC file from \a file.  If \a readProperties is true the file's audio properties will also be read.
             *
            ...
            /*!
             * Constructs an APE file from \a file.  If \a readProperties is true the file's audio properties will also be read.
             *
            ...
            /*!
             * Implements the unified property interface -- import function. This always creates a Xiph comment, if none exists. The return value relates to the Xiph comment only. Ignores any changes to ID3v1 or ID3v2 comments since they are not allowed in the FLAC specification.
             */
             ...
             *
             * If \a create is false (the default) this returns a null pointer if there is no valid ID3v2 tag.  If \a create is true it will create an ID3v2 tag if one does not exist and returns a valid pointer.
             *
             ...
             *
             * If \a create is false (the default) this returns a null pointer if there is no valid XiphComment.  If \a create is true it will create a XiphComment if one does not exist and returns a valid pointer.
             *
            ...
            /*!
             * Removes an attached picture. If \a del is true the picture's memory will be freed; if it is false, it must be deleted by the user.
             */
