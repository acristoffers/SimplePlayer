...
namespace TagLib
{
    namespace RIFF
    {
         ...
         *
         * This supports an ID3v2 tag as well as reading stream from the ID3 RIFF chunk as well as properties from the file.
         */
        ...
        namespace WAV
        {
            ...
            public:
                ...
                /*!
                 * Constructs a WAV file from \a file.  If \a readProperties is true the file's audio properties will also be read.
                 *
                ...
                /*!
                 * Constructs a WAV file from \a stream.  If \a readProperties is true the file's audio properties will also be read.
                 *
                 ...
                 * Returns the ID3v2 Tag for this file.
                 *
                 * \note This always returns a valid pointer regardless of whether or not the file on disk has an ID3v2 tag.  Use hasID3v2Tag() to check if the file on disk actually has an ID3v2 tag.
                 *
                 * \see hasID3v2Tag()
                 */
                 ...
                 *
                 * \note This always returns a valid pointer regardless of whether or not the file on disk has a RIFF INFO tag.  Use hasInfoTag() to check if the file on disk actually has a RIFF INFO tag.
                 *
                 * \see hasInfoTag()
                 */
