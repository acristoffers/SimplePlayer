...
namespace TagLib
{
    namespace ID3v2
    {
         ...
         *
         * \note If non-Latin1 compatible strings are used with this class, even if the text encoding is set to Latin1, the frame will be written using UTF8 (with the encoding flag appropriately set in the output).
         */
        ...
        public:
            /*!
             * Construct an empty frame of type \a type.  Uses \a encoding as the default text encoding.
             *
            ...
            /*!
             * This is a special factory method to create a TIPL (involved people list) frame from the given \a properties. Will parse key=[list of values] data into the TIPL format as specified in the ID3 standard.
             */
            static TextIdentificationFrame *createTIPLFrame(const PropertyMap &properties);

            /*!
             * This is a special factory method to create a TMCL (musician credits list) frame from the given \a properties. Will parse key=[list of values] data into the TMCL format as specified in the ID3 standard, where key should be of the form instrumentPrefix:instrument.
             */
             ...
             *
             * \note This will not change the text encoding of the frame even if the strings passed in are not of the same encoding.  Please use setEncoding(s.type()) if you wish to change the encoding of the frame.
             */
        ...
        private:
            ...
            /*!
             * Parses the special structure of a TIPL frame Only the whitelisted roles "ARRANGER", "ENGINEER", "PRODUCER",
        ...
        public:
            ...
            /*!
             * Sets the description of the frame to \a s.  \a s must be unique.  You can check for the presence of another user defined text frame of the same type using find() and testing for null.
             */
             ...
             * - if the above rules don't yield a valid key (e.g. containing non-ASCII characters), the returned map will contain an entry "TXXX/<description>"
            ...
            /*!
             * Searches for the user defined text frame with the description \a description in \a tag.  This returns null if no matching frames were found.
             */
